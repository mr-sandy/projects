namespace Integration.Tests.ProjectModuleTests
{
    ...
    public class WhenDeletingAProject : ContextBase
    {
        [SetUp]
        public void SetUp()
        {
            ...
            this.Response = this.Client.Delete("/projects/1", with =>
            {
        ...
        public void ShouldReturnJsonBody()
        {
            ...
            resource.Links.FirstOrDefault(l => l.Rel == "self")?.Href.Should().Be("/projects/1");
        }
    }
}