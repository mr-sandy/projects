namespace Integration.Tests.ProjectModuleTests
{
    ...
    public class WhenAddingAProjectWithPhaseQuery : ContextBase
    {
        [SetUp]
        public void SetUp()
        {
            ...
            this.Response = this.Client.Post("/projects?phases=3", payload, with =>
            {
        ...
        public void ShouldReturnJsonBody()
        {
            ...
            resources.Phases.Should().HaveCount(3);
        }
    }
}