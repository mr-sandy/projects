namespace Unit.Tests.ProjectTests
{
    ...
    public class WhenRemovingAPhase
    {
        ...
        public void SetUp()
        {
            ...
            var activity = new RemovePhaseActivity("/employees/1", 0);

            this.project.RemovePhase(activity);
        }

        [Test]
        public void TheProjectShouldHaveOnePhase()
        {
            this.project.Phases.Should().HaveCount(0);
        }
        ...
        public void TheAddPhaseActivityShouldBeRecorded()
        {
            ...
            this.project.Activities.OfType<RemovePhaseActivity>().Should().HaveCount(1);
        }
    }
}